...
export function Home() {
  ...
  return (
    <div className="grid min-h-screen place-items-center container mx-auto p-8 text-center relative z-10">
      <div className="flex lg:flex-row flex-col">
        <img
          src={reactLogo}
          alt="React Logo"
          className="h-40 m-0 transition-all duration-300 hover:drop-shadow-[0_0_2em_#61dafbaa] animate-[spin_20s_linear_infinite]"
        />
        <ul className="lg:ml-6 flex flex-col justify-center gap-2 w-120">
          ...
          <li>
            <div className="flex flex-row justify-center pt-4 space-x-4">
              {configurationQuery.isLoading || userQuery.isLoading ? (
